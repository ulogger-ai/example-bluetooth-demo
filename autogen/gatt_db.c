...
{
  0x55, 0xf7, 0x9f, 0x7d, 0x03, 0x04, 0x28, 0xab, 0x63, 0x43, 0x20, 0x14, 0x69, 0xe7, 0x28, 0x18, 
  0x55, 0xf7, 0x9f, 0x7d, 0x03, 0x04, 0x28, 0xab, 0x63, 0x43, 0x20, 0x14, 0x69, 0xe7, 0x28, 0x38, 
  0xda, 0xc6, 0x04, 0xba, 0x70, 0xdd, 0xd4, 0xbb, 0x25, 0x4f, 0xf9, 0x59, 0xa5, 0xfb, 0xb0, 0x15, 
  0x72, 0x3a, 0x28, 0xf2, 0x56, 0xaa, 0x02, 0x93, 0x97, 0x42, 0x9d, 0x8f, 0x9d, 0x11, 0xd8, 0x3a, 
  0x55, 0xf7, 0x9f, 0x7d, 0x03, 0x04, 0x28, 0xab, 0x63, 0x43, 0x20, 0x14, 0x69, 0xe7, 0x28, 0x58, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_24) = {
  .len = 16,
  .data = { 0x0c, 0xf4, 0x53, 0xec, 0x93, 0x09, 0xc7, 0x88, 0x7c, 0x4c, 0x06, 0x1a, 0x1f, 0xe3, 0x1f, 0x69, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 15,
  .data = { 0x75, 0x4c, 0x6f, 0x67, 0x67, 0x65, 0x72, 0x20, 0x45, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1d, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x0c, .char_uuid = 0x8001 } },
  { .handle = 0x1e, .uuid = 0x8001, .permissions = 0x806, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_29 },
  ...
  { .handle = 0x22, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x12, .char_uuid = 0x8003 } },
  { .handle = 0x23, .uuid = 0x8003, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x02, .dynamicdata = &gattdb_attribute_field_34 },
  { .handle = 0x24, .uuid = 0x000d, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x01, .clientconfig_index = 0x03 } },
  { .handle = 0x25, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x0c, .char_uuid = 0x8004 } },
  { .handle = 0x26, .uuid = 0x8004, .permissions = 0x806, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_37 },
  { .handle = 0x27, .uuid = 0x0000, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x00, .constdata = &gattdb_attribute_field_38 },
  { .handle = 0x28, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x08, .char_uuid = 0x8005 } },
  { .handle = 0x29, .uuid = 0x8005, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
};
